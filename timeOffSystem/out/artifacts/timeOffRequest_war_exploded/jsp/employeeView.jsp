...
<p>fist name: <%=employee.getFirstName()%></p>
<p>last name: <%=employee.getLastName()%></p>
<p>national code: <%=employee.getNationalCode()%></p>
<p>role: <%=role.getName()%></p>
<p>phone number: <%=employee.getPhoneNumber()%></p>
<p>email address: <%=employee.getAddress()%></p>
    <%
        if (employee.getManager() != null){
    %>
<p>manager: <%=employee.getManager().getFirstName()%> <%=employee.getManager().getLastName()%></p>
    <%
        }else
    %>
    <p>manager: null</p>
