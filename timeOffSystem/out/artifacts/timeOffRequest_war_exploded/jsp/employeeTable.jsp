...
<button onclick="window.location.href = 'employeeSaveForm.jsp';" style="margin-left: 20px; color: white; background-color: #3c1a64; padding: 7px">INSERT EMPLOYEE</button>
<footer>
