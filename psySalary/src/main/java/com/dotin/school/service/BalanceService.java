...
public class BalanceService {
    ...
    public void initBalanceFile(String balancePath, String paymentPath, String separator) throws FileFormatException {
        PaymentService paymentService = new PaymentService();
        List<PaymentVO> paymentVOList = paymentService.readPaymentFile(paymentPath, separator);
        ...
        writeBalanceFile(balancePath, debtorBalanceVO);
    ...
    public List<BalanceVO> readBalanceFile(String path, String separator) throws FileFormatException {
    ...
    public void writeBalanceFile(String path, BalanceVO balanceVO) {
        Path balancePath = Paths.get(path);
        try {
    ...
    public void updateBalanceFile(Map<String, Type> paymentMap, String balancePath, String separator, PaymentVO paymentVO) throws FileFormatException, IOException, DepositNotFoundException {
